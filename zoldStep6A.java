...
public class Step6A {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 3) {
			System.err.println("Usage: Step6A (HDFS point and neighbor file) (HDFS point and LRD) (HDFS output file)");
			System.exit(2);
		}

		Configuration conf = new Configuration();
		Job job = new Job(conf, "Step 6A");

		job.setJarByClass(Step6A.class);
