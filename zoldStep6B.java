...
public class Step6B {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 3) {
			System.err.println("Usage: Step6A (HDFS point and LRD of neighbors) (HDFS point and LRD of self) (HDFS output file)");
			System.exit(2);
		}

		Configuration conf = new Configuration();
		Job job = new Job(conf, "Step 6B");

		job.setJarByClass(Step6B.class);
